...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{results/diff_NoIce_recloud_Day2.png}
...
The downward LW radiation flux at the surface has been increased due to the increase in LWP, which means that there is more water in the clouds and they emit more LW to the ground. %This is also quite clear from the theory, the equation for the cloud optical depth in the LW spectra may be written $\tau_IR = \frac{3LWP}{4\rho_l r_e}$.
