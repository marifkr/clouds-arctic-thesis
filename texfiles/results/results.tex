...
Looking back to figure~\ref{fig:seaice} in Chapter~\ref{chap:modmet}, one can also see that the sea ice fraction is higher further north, which explains the lower LH for that area in the control run.
...
\centering
	...
	\end{subfigure}
\caption{The averaged difference in LWP, CDNC and $r_e$ of cloud droplets (from left to right) for the run with no ice minus the control run, over the lowermost 11 layers for day 1.}
...
\centering
	...
	\end{subfigure}
	\caption{Average difference in LH, SH and skin temperature for NoIce-Control, day1.}
...
The increase in effective radius in the same area as the LWP is increased also indicates the formation of a new cloud,figure~\ref{fig:recloud_r2Day1}, that could not form in the control run (see figure~\ref{fig:recloud_r1Day1}).
...
The slight increase in the LW at TOA is because of increased temperature at the surface when the sea ice is removed (figure~\ref{fig:skintemp_r2_day1}).
...
\centering
	...
	\end{subfigure}
	\caption{Average difference in LH, SH and skin temperature for NoIce-Control, day 5.}
