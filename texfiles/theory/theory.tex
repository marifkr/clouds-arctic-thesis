...
In this thesis shortwave (SW) radiation refers to solar radiation incident on the earth-atmosphere system, with wavelengths in the visible spectrum ($\lambda = @wallacehobbs2006$). Longwave (LW) radiation refers to wavelengths emitted by the earth-atmosphere system, with wavelengths in the infrared spectrum ($\lambda = @$). 
