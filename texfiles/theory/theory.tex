...
\caption{Size of CCN, typical cloud droplet, boarderline between cloud droplet and rain drop and typical size of rain drop. Adapted from~\citep{McDonald1958}.}
\label{fig:Schf01}
\end{figure}
...
If the LWC is integrated over the height of the cloud or any layer, we find the liquid water path (LWP) of that layer.
\begin{equation}
LWP = \int_{base}^{top} LWC dz
\end{equation}
The LWP is the column of liquid water in a cloudand is usually expressed by $g~m^{-2}$.
