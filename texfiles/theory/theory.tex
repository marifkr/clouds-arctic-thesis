...
\section{Aerosol effects on clouds}%Aerosols and clouds som tittel??
...
----
There are two known indirect effects that aerosols have on radiation, through clouds. The first indirect effect was proposed by~\cite{Twomey1974} and is often referred to as the Twomey effect. The second indirect effect was proposed by~\cite{Albrecht1989} and is also known as the lifetime effect.
